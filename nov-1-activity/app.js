...
const matchingPhoto = list.find(function(item) {
...
// Log the results
if (matchingPhoto) {
  console.log(`Found an id number of ${inputValue}:  `, matchingPhoto);
 // console.log(matchingPhoto)
  console.log(`Search another one...`)
} else {
  console.log(`Could not find an id of ${inputValue}. Please try again.`);
}